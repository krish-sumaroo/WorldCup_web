...
class BaseGameActionValidator extends Validator
{
    ...
    public function validateAddGameAction($fkGameId, $fkUserId, $actionMinute, $actionDate, $actionAutomaticDate, $actionType)
    {
    ...
    public function validateEditGameAction($fkGameId, $fkUserId, $actionMinute, $actionDate, $actionAutomaticDate, $actionType)
    {
        $this->validateLength($fkGameId, "Fk Game Id", BaseGameActionLogicUtility::$FK_GAME_ID_LIMIT);
