...
class BaseRedCardActionLogicUtility
{
    ...
    {
        return BaseBannerLogicUtility::getSpecificDetails($fkGameActionId, BaseRedCardActionLogicUtility::$FK_GAME_ACTION_ID_FIELD);
    }
    ...
    {
        BaseRedCardActionLogicUtility::updateSpecificField($fkGameActionId, $value, BaseRedCardActionLogicUtility::$FK_PLAYER_ID_FIELD, $value);
    }
    ...
    public static function addAllFields(QueryBuilder $queryBuilder)
    {
        ...
        $queryBuilder->addFields(BaseRedCardActionLogicUtility::$FK_PLAYER_ID_FIELD);
