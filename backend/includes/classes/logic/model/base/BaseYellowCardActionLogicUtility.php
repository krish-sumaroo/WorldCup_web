...
class BaseYellowCardActionLogicUtility
{
	...
	return BaseBannerLogicUtility::getSpecificDetails($fkGameActionId,
			BaseYellowCardActionLogicUtility::$FK_GAME_ACTION_ID_FIELD);
    }

    public static function getFkPlayerId($fkGameActionId)
    {
	return BaseBannerLogicUtility::getSpecificDetails($fkGameActionId,
			BaseYellowCardActionLogicUtility::$FK_PLAYER_ID_FIELD);
    }
    ...
    {
	BaseYellowCardActionLogicUtility::updateSpecificField($fkGameActionId, $value,
		BaseYellowCardActionLogicUtility::$FK_PLAYER_ID_FIELD, $value);
    }
	...
	$queryBuilder->addFields(BaseYellowCardActionLogicUtility::$FK_GAME_ACTION_ID_FIELD,
		BaseYellowCardActionLogicUtility::$TABLE_NAME);
