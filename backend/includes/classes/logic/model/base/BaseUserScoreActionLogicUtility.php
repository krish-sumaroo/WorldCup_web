...
class BaseUserScoreActionLogicUtility
{
    ...
    public static function addUserScoreAction($gameId, $team1Id, $team1Score, $team2Score, $team2Id, $userId,
	    $timestamp, $points, $status)
    {
    ...
    public static function updateUserScoreAction($id, $gameId, $team1Id, $team1Score, $team2Score, $team2Id, $userId,
	    $timestamp, $points, $status)
    {
	$queryBuilder = new QueryBuilder();
	$queryBuilder->addTable(BaseUserScoreActionLogicUtility::$TABLE_NAME);
    ...
    {
	BaseUserScoreActionLogicUtility::updateSpecificField($id, $value, BaseUserScoreActionLogicUtility::$GAMEID_FIELD,
		$value);
    }

    public static function updateTeam1Id($id, $value)
    {
	BaseUserScoreActionLogicUtility::updateSpecificField($id, $value, BaseUserScoreActionLogicUtility::$TEAM1ID_FIELD,
		$value);
    }

    public static function updateTeam1Score($id, $value)
    {
	BaseUserScoreActionLogicUtility::updateSpecificField($id, $value, BaseUserScoreActionLogicUtility::$TEAM1SCORE_FIELD,
		$value);
    }

    public static function updateTeam2Score($id, $value)
    {
	BaseUserScoreActionLogicUtility::updateSpecificField($id, $value, BaseUserScoreActionLogicUtility::$TEAM2SCORE_FIELD,
		$value);
    }

    public static function updateTeam2Id($id, $value)
    {
	BaseUserScoreActionLogicUtility::updateSpecificField($id, $value, BaseUserScoreActionLogicUtility::$TEAM2ID_FIELD,
		$value);
    }

    public static function updateUserId($id, $value)
    {
	BaseUserScoreActionLogicUtility::updateSpecificField($id, $value, BaseUserScoreActionLogicUtility::$USERID_FIELD,
		$value);
    }

    public static function updateTimestamp($id, $value)
    {
	BaseUserScoreActionLogicUtility::updateSpecificField($id, $value, BaseUserScoreActionLogicUtility::$TIMESTAMP_FIELD,
		$value);
    }

    public static function updatePoints($id, $value)
    {
	BaseUserScoreActionLogicUtility::updateSpecificField($id, $value, BaseUserScoreActionLogicUtility::$POINTS_FIELD,
		$value);
    }

    public static function updateStatus($id, $value)
    {
	BaseUserScoreActionLogicUtility::updateSpecificField($id, $value, BaseUserScoreActionLogicUtility::$STATUS_FIELD,
		$value);
    }
	...
	return new UserScoreActionEntity($id, $gameId, $team1Id, $team1Score, $team2Score, $team2Id, $userId, $timestamp,
		$points, $status, $resultDetails);
    }
}
