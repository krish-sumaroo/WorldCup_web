...
class Configuration
{
    ...
    public static $URL = "http://localhost/applications/git/WorldCup_web/backend/"; //http://54.85.111.97/wc/master/backend/
    //database connection parameters
    public static $CONNECTION_PARAMETERS = array("host" => "54.85.111.97", "username" => "krish", "password" => "nokia555", "database" => "wc");
//    public static $CONNECTION_PARAMETERS = array("host" => "127.0.0.1", "username" => "root", "password" => "",
//	"database" => "wc_2014");
...
=======
>>>>>>> 4f37141b083e9445888920bf0e27687f2be97e61
}
